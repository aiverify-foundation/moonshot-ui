  ...
  return isLoading || !data ? null : (
    <Window
      ...
      <div className="flex flex-col bg-white w-full h-full">
        <div
          id="mainHeader"
          className="flex bg-fuchsia-1000 divide-x divide-neutral-400 pt-2 h-16 ">
          <div
            className={`COL-1 flex items-center pl-2 text-lg`}
            style={{ width: `${Col1Pixel}px` }}>
            Cookbook
          </div>
          <div
        ...
        <div className="overflow-x-auto overflow-y-auto custom-scrollbar divide-y divide-neutral-400">
          <div style={{ width: 'fit-content' }}>
            {/* 250% width to workaround scroll area not taking up the whole overflowed area*/}
            <div
              id="endpointNameHeader"
              className="flex text-gray-950 w-full bg-white h-[60px] divide-x divide-neutral-400 sticky top-0">
              <div
                className="COL-1 shrink-0 bg-fuchsia-1000"
                style={{ width: `${Col1Pixel}px` }}
              />
              <div
                className="COL-2 shrink-0 bg-fuchsia-1000"
                style={{ width: `${Col2Pixel}px`, minWidth: 150 }}
              />
              <div
                  ...
                  <div
                    ...
                    {book.recipes.map((rec, idx) => (
                      <div
                        ...
                        <div
                          className="COL-2 shrink-0 flex-initial px-2"
                          style={{ width: `${Col2Pixel}px`, minWidth: 150 }}>
                          {rec.id}
                        </div>
