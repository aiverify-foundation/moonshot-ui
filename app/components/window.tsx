    ...
    return (
      <div
        ...
        className={`absolute pt-0 text-white 
          shadow-lg select-none min-w-96 shadow-moondark-800/40 bg-fuchsia-1000/90 
          dark:shadow-moondark-900/30 dark:bg-moondark-950 backdrop-blur-sm 
        ...
        <div className="flex flex-col w-full h-full">
          <div
            className="flex flex-col w-full mb-6 bg-fuchsia-950/40 dark:bg-moondark-950"
